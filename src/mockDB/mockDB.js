const sneakers = [
    {
        ID: 1,
        Name: "Basketball Nike Kyrie Flytrap 6",
        Brand: "Nike",
        Size: [43],
        Price: 161300,
        Gender: "Man",
    ...
    {
        ID: 2,
        Name: "Basketball Under Armour Buzzer",
        Brand: "Under Armor",
        Size: [42, 43, 44],
        Price: 140000,
        Gender: "Man",
    ...
    {
        ID: 4,
        Name: "Football Under Armour Magnetico Select 2.0 Fg",
        Brand: "Under Armor",
        Size: [42, 44, 45],
        Price: 115000,
        Gender: "Male",
    ...
    {
        ID: 5,
        Name: "Running Puma Softride Sway",
        Brand: "Puma",
        Size: [34, 35],
        Price: 120000,
        Gender: "Female",
    ...
    {
        ID: 8,
        Name: "Tennis Nike Zoom Vapor Cage 4 Rafa",
        Brand: "Nike",
        Size: [39, 41, 42, 44],
        Price: 257000,
        Gender: "Male",
    ...
    {
        ID: 9,
        Name: "Trekking Topper Gondor II",
        Brand: "Topper",
    ...
    {
        ID: 10,
        Name: "Trekking Adidas Terrex Soulstride",
        Brand: "Adidas",
        Size: [44, 45],
        Price: 101500,
        Gender: "Male",
